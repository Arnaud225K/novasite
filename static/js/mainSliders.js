(() => {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !d(i)) {
                ...
                for (let t = 0, r = s.length; t < r; t += 1) {
                    ...
                    void 0 !== n && n.enumerable && (l(e[r]) && l(i[r]) ? i[r].__swiper__ ? e[r] = i[r] : c(e[r], i[r]) : !l(e[r]) && l(i[r]) ? (e[r] = {}, i[r].__swiper__ ? e[r] = i[r] : c(e[r], i[r])) : e[r] = i[r])
                }
            }
        }
        return e
    ...
    function y(e) {
        return void 0 === e && (e = {}), b || (b = function(e) {
            ...
            const u = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                f = "Win32" === r;
            let h = "MacIntel" === r;
            return !p && h && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (p = a.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), h = !1), c && !f && (o.os = "android", o.android = !0), (p || m || u) && (o.os = "ios", o.ios = !0), o
        }(e)), b
    }
        ...
        O = e => {
            ...
            if (e.params.rewind || e.params.loop)
                for (let i = r - t; i <= n + t; i += 1) {
                    ...
                    for (let i = Math.max(r - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && (i > n || i < r) && I(e, i)
        };
    var A = {
        updateSize: function() {
            const e = this;
        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < u; i += 1) {
                let r;
                if (k = 0, c[i] && (r = c[i]), C && e.grid.updateSlide(i, r, c), !c[i] || "none" !== v(r, "display")) {
                    if ("auto" === s.slidesPerView) {
                        L && (c[i].style[e.getDirectionLabel("width")] = "");
                        const n = getComputedStyle(r),
                            a = r.style.transform,
                            o = r.style.webkitTransform;
                        if (a && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths) k = e.isHorizontal() ? w(r, "width", !0) : w(r, "height", !0);
                        else {
                            const e = t(n, "width"),
                                s = t(n, "padding-left"),
                                i = t(n, "padding-right"),
                        ...
                        a && (r.style.transform = a), o && (r.style.webkitTransform = o), s.roundLengths && (k = Math.floor(k))
                    } else k = (n - (s.slidesPerView - 1) * E) / s.slidesPerView, s.roundLengths && (k = Math.floor(k)), c[i] && (c[i].style[e.getDirectionLabel("width")] = `${k}px`);
                    c[i] && (c[i].swiperSlideSize = k), g.push(k), s.centeredSlides ? (y = y + k / 2 + M / 2 + E, 0 === M && 0 !== i && (y = y - n / 2 - E), 0 === i && (y = y - n / 2 - E), Math.abs(y) < .001 && (y = 0), s.roundLengths && (y = Math.floor(y)), P % s.slidesPerGroup === 0 && f.push(y), h.push(y)) : (s.roundLengths && (y = Math.floor(y)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup === 0 && f.push(y), h.push(y), y = y + k + E), e.virtualSize += k + E, M = k, P += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, n) + T, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+E}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+E}px`), C && e.grid.updateWrapperSize(k, f), !s.centeredSlides) {
                const t = [];
            ...
            if (u !== d && e.emit("slidesLengthChange"), f.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== x && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
        ...
        updateSlidesProgress: function(e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                h && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), C(l, h, s.slideVisibleClass), C(l, f, s.slideFullyVisibleClass), l.progress = r ? -c : c, l.originalProgress = r ? -p : p
            }
        },
        ...
        updateSlidesClasses: function() {
            const e = this,
                ...
                o = e => m(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
            let l, d, c;
            if (n)
                if (s.loop) {
    ...
    function z(e) {
        ...
        let o = i;
        o || (o = n > a ? "next" : n < a ? "prev" : "reset"), t.emit(`transition${r}`), s && "reset" === o ? t.emit(`slideResetTransition${r}`) : s && n !== a && (t.emit(`slideChangeTransition${r}`), "next" === o ? t.emit(`slideNextTransition${r}`) : t.emit(`slidePrevTransition${r}`))
    }
    var G = {
            slideTo: function(e, t, s, i, r) {
                ...
                if ((!T || !r) && (m && -w === n.translate || !m && w === n.translate)) return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(w), "reset" !== S && (n.transitionStart(s, S), n.transitionEnd(s, S)), !1;
                if (o.cssMode) {
                    const e = n.isHorizontal(),
                        s = m ? w : -w;
                    if (0 === t) T && (n.wrapperEl.style.scrollSnapType = "none", n._immediateVirtual = !0), T && !n._cssModeVirtualInitialSet && n.params.initialSlide > 0 ? (n._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
            ...
            slideToClickedSlide: function() {
                ...
                let r, n = e.getSlideIndexWhenGrid(e.clickedIndex);
                const o = e.isElement ? "swiper-slide" : `.${t.slideClass}`,
                    l = e.grid && e.params.grid && e.params.grid.rows > 1;
                if (t.loop) {
                    if (e.animating) return;
                    r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? e.slideToLoop(r) : n > (l ? (e.slides.length - i) / 2 - (e.params.grid.rows - 1) : e.slides.length - i) ? (e.loopFix(), n = e.getSlideIndex(m(s, `${o}[data-swiper-slide-index="${r}"]`)[0]), a(() => {
                        e.slideTo(n)
                    })) : e.slideTo(n)
                } else e.slideTo(n)
            }
        ...
        _ = {
            ...
            loopFix: function(e) {
                ...
                T % S !== 0 && (T += S - T % S), T += h.loopAdditionalSlides, d.loopedSlides = T;
                const b = d.grid && h.grid && h.grid.rows > 1;
                c.length < w + T || "cards" === d.params.effect && c.length < w + 2 * T ? f("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : b && "row" === h.grid.fill && f("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                const x = [],
                    E = [],
                    y = b ? Math.ceil(c.length / h.grid.rows) : c.length,
                    M = a && y - g < w && !v;
                ...
                if (O < T) {
                    ...
                    I = Math.max(O - (y - 2 * T), S), M && (I = Math.max(I, w - y + g + 1));
                    for (let e = 0; e < I; e += 1) {
                        const t = e - Math.floor(e / y) * y;
                        b ? c.forEach((e, s) => {
                            e.column === t && E.push(s)
                ...
                if (d.__preventObserver__ = !0, requestAnimationFrame(() => {
                    ...
                    }), "cards" === d.params.effect && c.length < w + 2 * T && (E.includes(n) && E.splice(E.indexOf(n), 1), x.includes(n) && x.splice(x.indexOf(n), 1)), k && x.forEach(e => {
                    ...
                    }), d.recalcSlides(), "auto" === h.slidesPerView ? d.updateSlides() : b && (x.length > 0 && k || E.length > 0 && C) && d.slides.forEach((e, t) => {
                    ...
                    if (x.length > 0 && k) {
                        if (void 0 === t) {
                            ...
                            l ? d.setTranslate(d.translate - t) : (d.slideTo(P + Math.ceil(L), 0, !1, !0), r && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                        } else if (r) {
                    ...
                    if (void 0 === t) {
                        ...
                        const e = b ? E.length / h.grid.rows : E.length;
    ...
    function B(e) {
        ...
        if (void 0 === r.isScrolling) {
            let e;
            s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : f * f + h * h >= 25 && (e = 180 * Math.atan2(Math.abs(h), Math.abs(f)) / Math.PI, r.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
        }
    ...
    function N(e) {
        ...
        if (m > n.longSwipesMs) {
            ...
            !t.navigation || r.target !== t.navigation.nextEl && r.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== w ? w : v + b), "prev" === t.swipeDirection && t.slideTo(null !== S ? S : v)) : r.target === t.navigation.nextEl ? t.slideTo(v + b) : t.slideTo(v)
        }
    }
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const u = (p in a ? a[p] : void 0) || e.originalParams,
                        ...
                        v = u.grabCursor,
                        g = r.enabled;
                    m && !f ? (n.classList.remove(`${r.containerModifierClass}grid`, `${r.containerModifierClass}grid-column`), e.emitContainerClasses()) : !m && f && (n.classList.add(`${r.containerModifierClass}grid`), (u.grid.fill && "column" === u.grid.fill || !u.grid.fill && "column" === r.grid.fill) && n.classList.add(`${r.containerModifierClass}grid-column`), e.emitContainerClasses()), h && !v ? e.unsetGrabCursor() : !h && v && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
    ...
    class J {
        constructor() {
            ...
            const o = this;
            o.__swiper__ = !0, o.support = E(), o.device = y({
            ...
            const d = c({}, X, l);
            return o.params = c({}, d, K, t), o.originalParams = c({}, o.params), o.passedParams = c({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach(e => {
        ...
        mount(e) {
            ...
            return !r && t.params.createElements && (r = h("div", t.params.wrapperClass), s.append(r), m(s, `.${t.params.slideClass}`).forEach(e => {
                r.append(e)
            })), Object.assign(t, {
                el: s,
                wrapperEl: r,
    ...
    function Q(e) {
        ...
        s({
            ...
            e = S(e), s = S(s), t.enabled ? o() : [...e, ...s].filter(e => !!e).forEach(e => e.classList.add(t.params.navigation.lockClass))
        }), i("click", (e, s) => {
            let {
                nextEl: i,
                prevEl: n
    ...
    Object.keys(U).forEach(e => {
        ...
        navigation: {
            nextEl: "#special-offers-right",
            prevEl: "#special-offers-left"
        }
    }), new J(".reviews__slider", {
        modules: [Q],
        breakpointsBase: "container",
        slidesPerView: 4,
        breakpoints: {
